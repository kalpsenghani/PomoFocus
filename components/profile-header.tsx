  ...
  return (
    <Card className="p-8 bg-black/20 backdrop-blur-sm border-neutral-700/40 rounded-2xl">
      <div className="flex flex-col md:flex-row items-start md:items-center space-y-6 md:space-y-0 md:space-x-8">
        ...
        <div className="flex-1 grid grid-cols-2 md:grid-cols-4 gap-4">
          <motion.div
            ...
            className="text-center p-4 bg-white/5 rounded-xl border border-neutral-700/40"
          >
      ...
      <motion.div
        ...
        className="mt-6 pt-6 border-t border-neutral-700/40"
      >
        <div className="flex items-center justify-between mb-2">
          <span className="text-sm text-neutral-400">Level {profile.level} Progress</span>
